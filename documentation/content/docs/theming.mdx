...
| `Success` | <Swatch light="#3fb950" dark="#3fb950" /> | `Brush.Success` | Positive status (optional, has a default) |
| `Warning` | <Swatch light="#d29922" dark="#d29922" /> | `Brush.Warning` | Caution status (optional, has a default) |
