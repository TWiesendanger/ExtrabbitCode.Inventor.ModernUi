...
The extra indent of child items is the `Margin.TreeIndent` token (default `8,0,0,0`, on top of the
16px expander column). Override it per tree — or window-wide in the window's resources — for a
compact layout:
...
<ThemedImage slug="data__tree-view-compact-indent" alt="Tree view with compact indent" />
