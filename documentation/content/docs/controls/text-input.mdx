...
| Hover | Focus |
|---|---|
| <ThemedImage slug="text-input__text-box--hover" alt="Text box on hover" /> | <ThemedImage slug="text-input__text-box--focused" alt="Text box focused" /> |
...
| Hover | Focus |
|---|---|
| <ThemedImage slug="text-input__search-box--hover" alt="Search box on hover" /> | <ThemedImage slug="text-input__search-box--focused" alt="Search box focused" /> |
