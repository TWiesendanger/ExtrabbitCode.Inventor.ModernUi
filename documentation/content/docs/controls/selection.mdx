...
| Checked | Unchecked |
|---|---|
| <ThemedImage slug="selection__check-box" alt="Checked check box" /> | <ThemedImage slug="selection__check-box-unchecked" alt="Unchecked check box" /> |
...
| On | Off |
|---|---|
| <ThemedImage slug="selection__toggle-switch" alt="Toggle switch on" /> | <ThemedImage slug="selection__toggle-switch-off" alt="Toggle switch off" /> |
...
<ThemedImage slug="selection__toggle-switch-on-a-togglebutton" alt="Toggle switch on a ToggleButton" />
