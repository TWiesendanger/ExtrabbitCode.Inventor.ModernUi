...
`Badge` (neutral), `BadgeAccent`, `BadgeSuccess`, `BadgeWarning` and `BadgeError` render pill-shaped
labels, colored from the themed status brushes (`Brush.Success` / `Brush.Warning` / `Brush.Error`).
